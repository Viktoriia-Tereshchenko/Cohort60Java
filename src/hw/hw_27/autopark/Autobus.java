 ...
 */
    public String toString() {
        ...
        sb.append(", passenger: ").append(countPassengers).append(" } ");
    ...
    public boolean dropPassenger(Passenger passenger) {
        ...
        2. Удалить его из массива
            2.1. Сдвинуть всех справа
            2.2.Изменить кол-во пассажиров
            2.3 вернуть true
         */
        ...
        passengers[countPassengers - 1] = null; // не обязательно
        // обязательно
        countPassengers--;
