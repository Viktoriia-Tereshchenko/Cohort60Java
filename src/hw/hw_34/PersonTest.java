...
public class PersonTest {
    ...
    3. Ожидаем: что у person в поле email будет значение, которое мы установили в шаге 2
     */
    ...
    3. Ожидаемый результат: такой email установлен не будет
        3.1 поле email у person НЕ будет равно "не валидный email"
        3.2 Значение поля email у person должно остаться прежним = startEmail
     */
