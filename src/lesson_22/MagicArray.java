...
public class MagicArray {
    ...
    // int... - это называется СИКВЕНЦИЯ
    void add(int... numbers) {
        // с numbers я могу обращаться точно также, как ссылкой на масиив int
...
8. Удаление элемента по значению. Возвращает boolean.
9. Поиск по значению. Возвращать индекс первого вхождения элемента ++
10. Поиск по значению. Возвращать индекс последнего вхождения элемента
11. Конструктор (посмотреть у СЕРГЕЯ)
 */