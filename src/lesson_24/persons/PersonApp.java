...
Массив, элементы которого являются ссылками на объект.
 */
...
public class PersonApp {
    public static void main(String[] args) {
        ...
        Person[] people = new Person[5]; // Создаю массив для 5 ссылок на объекты Person
        ...
        Person deleteMe = new Person("DeleteMe", 5 , "crashing");
        deleteMe = null; // сборщик мусора через время удалит объект из памяти
        // Garbage collector
