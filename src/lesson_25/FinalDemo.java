...
// Ключевое слово final. Оно может применять к классам, членам классов (полям, методам),
// переменным (в том числе к аргументам методов)
...
public class FinalDemo {
    ...
    // Параметры методы тоже можно пометить как fin
