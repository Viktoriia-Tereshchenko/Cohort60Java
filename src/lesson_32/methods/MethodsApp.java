...
public class MethodsApp {
    public static void main(String[] args) {
        ...
        //Util.swap(intArray, 1, 2); // массив примитивов не примет !!
        ...
        System.out.println("stringList[0]: " + Utils.getFirstElement(stringList));

        System.out.println("\n==============================");

        //int sum = Util.sumElements("Hello", "World"); // типобезопасность
        int sum = Utils.sumElements(1, 3.5, 10, 11.5, 1.1);
        System.out.println("sum: " + sum);

        //double sumD = Utils.listSum(stringList);  // ограничение сверху
        double sumD = Utils.listSum(doubleList);
        System.out.println("sumD: " + sumD);

        System.out.println("\n==============================");

        //Utils.addNumbers(doubleList);  // ограничение снизу
