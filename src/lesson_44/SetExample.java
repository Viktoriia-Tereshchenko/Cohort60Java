...
public class SetExample {
    public static void main(String[] args) {
        ...
        // хеширование позволяет быстро манипулировать данными!

        // Set - НЕ упорядоченная коллекция

        // Конструкторы
        Set<Integer> set = new HashSet<>(); // создается пустой hashSet. Емкость 16 и коэффициент заполнения 0.75
        ...
        List<Integer> startValues = List.of(15, 1, 2, 3, 4, 8, 6, 15, 7, 0, 16, 32);
        ...
        System.out.println("integers.add(100) #2: " + integers.add(100)); // false - элемент не добавлен,т.к. такое значение уже есть в Set
        System.out.println(integers);

        System.out.println("==========================================");

        // boolean remove(E e) - удаление элемента (метод НЕ перегружен, принимает только объекты)
        // В Set-ах индексов не существует !
        ...
        /*
        int size() - возвращает кол-во элементов в сете
        ...
        // Конструкторы SortedSet
        // Пустой - естественный порядок сортировки
        SortedSet<Integer> sortedSet = new TreeSet<>(); // пустое упорядоченное множество. Сортировка в соответвии с Comparable
        ...
        // Принимает коллекци, создает set из элементов коллекции. Сортировка в ест-м порядке
        sortedSet = new TreeSet<>(startValues);
        System.out.println(sortedSet);

        // Конструктор с компаратором, определяющий порядок хранения элементов
        // будет поддерживаться порядок, обратный естественному
        ...
        // last() - возвращает последний (самый правый / максимальный) элемент
        ...
        // SortedSet<E> tailSet(E element) - возвращает часть множества, элементы которого БОЛЬШЕ ИЛИ РАВНЫ element
        SortedSet<Integer> tailSet = treeSet.tailSet(6);
        System.out.println("treeSet.tailSet(6): " + tailSet);


        // SortedSet<E> subSet(E fromElement, E toElement) - возвращает часть множества, от fromElement (вкл) до toElement (не вкл)
    ...
    private static void  homework(String testStr) {
        ...
        String newString = testStr.replaceAll("[^a-zA-zа-яА-Я0-9 ]", ""); // ^ - НЕ
    ...
    public static <T> List<T> getUniqueList(List<T> list) {
        // Получить коллекцию из уникальных элементов
        // Позаботиться о порядке элементов изначального списка
        Set<T> set = new LinkedHashSet<>(list);

        // Преобразовать коллекцию уник-х элементов в список
