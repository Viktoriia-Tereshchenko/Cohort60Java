...
//        System.out.println();
        ...
        /*
        ФОКУС. Живая связь
        Метод keySet values возвращает представление / проекцию (view) соответсвующих ключей и значений карты.
        Эта проекция поддерживается самой картой, что означает, что они напрямую связаны с внутренними данными Map-ы.
        Поэтому любые изменения, внесенные в эти представления, отражаются на исходной карты.
        ...
        System.out.println("=====================\n");
        // Если хотим разорвать "связь" - нужно копировать элементы в другую коллекцию
        ...
        System.out.println(map.put(11, "green")); // если такой ключ есть - значение для него будет переписано
        System.out.println("map: " + map);
